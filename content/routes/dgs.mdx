...
Start with a rightward traverse to a flake and then jam a hand-fist crack to a large ledge with a big fir tree.(A more challenging first pitch is "The death of Abraham Lincoln by mounties" (5.11c), which goes up the steep face and corner just right of the regular first pitch. )

- The start
- Starting P1 - A little traverse over to the awkward wider crack
