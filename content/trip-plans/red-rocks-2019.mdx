...
- Geronimo - 5.6, 4 pitches, 2.8 stars from 283 votesDescent might have some rope snags, you have to rap it? Three ppl said descent sucksOne person liked Cat in the Hat and Johnny Vegas moreTwo people say kinda sketchy rock quality, especially P1, and then P4 is apparently worse with runout slab and then chossy chimneyDoesn't top out on anythingSounds like climbing is decent, but many people say the rappel descent makes it not worth it
...
- Sandy Hole - 5.6, 3 pitches, 2.5 from 33 votesA bit of a walk in, we'd want to find something else to climb with it?
